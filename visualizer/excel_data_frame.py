    ...
    def GetScalingTables(self, scalingfield, runids):
        ...
        if scalingfield == "volume":
            for qd in runids:
                ...
                scalingTables.append([["qd=" + str(qd), 0, len(runids[qd]) + 1], ["volume", 0, 1], ["Seq_Write_64K", 1, 0], "", ["Seq_Read_64K", 1, 0], "",  ["Seq_Write_4K", 1, 0], "", ["Seq_Read_4K", 1, 0]])
            ...
            for vm in runids:
                ...
                scalingTables.append([["volume=" + str(vm), 0, len(runids[vm]) + 1], ["QD", 0, 1], ["Seq_Write_64K", 1, 0], "", ["Seq_Read_64K", 1, 0], "", ["Seq_Write_4K", 1, 0], "", ["Seq_Read_4K", 1, 0]])
                scalingTables.append(["", "", "BW (MB/s)", "average latency (ms)", "BW (MB/s)", "average latency (ms)", "IOPS", "average latency (ms)", "IOPS", "average latency (ms)"])
                start_qdchart += 2
                for qd in runids[vm]:
