  ...
  while ($line ne ""){
    ...
    if ($lineNum==1) {
      ...
      if ($numSamples[$colIdx] >= 3) {
        ...
        if (    (($avg > 100.0) && ($field > $avg * $spikeThreshold))
             || (($avg < 100.0) && ($field < $avg / $spikeThreshold)) ) {
          $spikes[$colIdx]++;
          if (0) {
          ...
          print "# of samples is ".$numSamples[$colIdx]."\n";
          print "sumup of samples is ".$samples[$colIdx]."\n";
          print "average is".$avg."\n";
          print "# of spikes is ".$spikes[$colIdx]."\n";
          print "==================\n"
          }
        } else {
